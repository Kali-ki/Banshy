...
from ExeAnalyser import analyze_pe
...
if __name__ == "__main__":
    #unzip(__LOCAL_PATH + "/../../DataSamples/EXEs/Infected.zip","/home/morlot--pinta/Documents/Banshy/Backend/Analysers/EXE/")
    unzip(__LOCAL_PATH + "/../../DataSamples/EXEs/Safe.zip","/home/morlot--pinta/Documents/Banshy/Backend/Analysers/EXE/")
    #analyse_folder(__LOCAL_PATH + "/../../Analysers/EXE/exes_infected/",True)
    analyse_folder(__LOCAL_PATH + "/../../Analysers/EXE/EXEs_safe/",True)
